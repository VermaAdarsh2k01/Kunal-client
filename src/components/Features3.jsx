...
export const Features3 = () => (
  <section className="w-full bg-gradient-to-b from-[#1B1F24] to-[#282E36] via-[#1B1F24] pb-10 lg:pb-0 md:pb-32 xs:pb-10 xs:pb-0pt-4">
    <motion.div
        initial={{ opacity: 0 }}
      ...
      >
        <div className="w-screen min-h-screen lg:px-16 px-6 xs:px-6 md:px-18 pt-10">
            <div className="flex items-center justify-start gap-2">
                <span className=" text-[#075FE4] font-black text-2xl">/</span>
                <p className=" text-2xl font-bold text-white">Author</p>
            </div>
            <div className="max-xs:flex-col lg:flex  items-center lg:justify-between mt-20 gap-20 lg:gap-10">
                <div className="sm:w-[100%] lg:w-[60%] xs:w-[100%]">
                    <img src={SitAndGrow.src} className=" w-[100%] lg:w-[90%] xs:w-[100%]"/>
                </div>
                <div className="w-[100%] lg:w-[40%] xs:w-[100%] flex flex-col items-center lg:items-start xs:items-center justify-center mt-20 lg:mt-0 xs:mt-20 gap-6 lg:gap-10 xs:gap-6">
                    <p className="text-white text-4xl lg:text-2xl font-black">Sit And Grow Rich</p>
                    <p className="text-white text-sm lg:text-base xs:text-base">In "Sit and Grow Rich," I unveil actionable strategies derived from my extensive experience in business and market expansion. This book empowers readers to harness passive income and strategic investments, paving the way to financial independence and enduring wealth. Ideal for aspiring entrepreneurs and seasoned investors seeking tangible growth and prosperity.</p>
                </div>
            </div>
        </div>
      </motion.div>
